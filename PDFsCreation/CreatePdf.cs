...
namespace PDFsCreation
{
    public class CreatePdf
    {
        ...
        public static void DefineCover(Document document)
        {
            ...
            Image image = section.AddImage("C:\\Users\\sinah\\source\\repos\\PDFsCreation\\PDFsCreation\\Images\\Apple.jpg");
            image.Width = "10cm";
        ...
        // Paragraph Layout Overview Page 1 -> 3
        public static void DefineParagraphs(Document document)
        {
            ...
            DemonstrateAlignment2(document);
        ...
        // Alignment Page 1 -> 3
        static void DemonstrateAlignment2(Document document)
        {
